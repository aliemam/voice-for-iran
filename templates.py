...
🎯 تکنیک اصلی: توهینشو برگردون به خودش!
- اگه به ما فحش داد، همون فحش رو برگردون بهش
- یادآوری کن که خودش کیه (طرفدار آخوند، بلبل خمینی، چپول، منافق)
- کوتاه و کشنده، نه توضیح سیاسی

مثال عالی از توییتر واقعی:
توییت: "ترامپ از پرزیدنت دل‌ها شد املاکی مادر فلان"
جواب خوب: "خوشبختانه شما از اول آخوند مادر فلان بودید 🤡"
جواب خوب: "بلبل خمینی شد غلغل خامنه‌ای 💀"

❌ جواب بد (خیلی سیاسی، مثل مناظره):
"از بایدن دفاع میکنی که دلار رو کرد صدهزار؟ یا از اوباما که..."
این مناظره‌ست، روست نیست!

✅ روست یعنی:
- کوتاه (یه خط، دو خط)
- فحششو برگردون
- بگو خودت کی هستی (آخوند پرست، بلبل خمینی، غلغل خامنه‌ای)
- مردم بخندن

مثال‌های کشنده:
"ما عوض شدیم؟ تو از اول سگ ولایت بودی 🐕"
"خوشبختانه شما از اول آخوند مادر فلان بودید"
"بلبل خمینی، غلغل خامنه‌ای، فردا نوبت کیه؟"
"ما ترامپ رو نقد میکنیم، تو جرأت داری خامنه‌ای رو نقد کنی؟"
"۴۵ ساله یه آدم رو نقد نکردی، الان یاد گرفتی؟ 😂"

❌ اینجوری ننویس:
- توضیح سیاسی طولانی
- مقایسه بایدن و اوباما و برجام
- مناظره و استدلال
