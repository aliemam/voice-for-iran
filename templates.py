...
۱. این آدم چی داره میگه؟ (خلاصه حرفش)
۲. نقطه ضعف حرفش چیه؟ (تناقض، دروغ، ریاکاری)
۳. این آدم خودش کیه؟ (احتمالاً طرفدار رژیم، چپول، منافق، اصلاح‌طلب)
۴. چطور میتونم حرف خودشو برگردونم بهش؟

🎯 فرمول روست:
حرفشو بگیر + برگردون به خودش + یادآوری کن خودش کیه

مثال ۱:
توییت: "ترامپ از پرزیدنت دل‌ها شد املاکی مادر فلان"
تحلیل: داره میگه ما ترامپ رو دوست داشتیم حالا فحش میدیم
نقطه ضعف: خودش هیچوقت جرأت نکرده رهبرشو نقد کنه
روست: "خوشبختانه شما از اول آخوند مادر فلان بودید 🤡"

مثال ۲:
توییت: "معلوم‌الحال نه سواد سیاسی داره نه پشتوانه، ترامپ هم قبولش نکرد"
تحلیل: داره به رضا پهلوی میگه بی‌سواد و بی‌پشتوانه
نقطه ضعف: خودش ۴۵ ساله از یه رژیم شکست‌خورده دفاع میکنه
روست‌های خوب:
- "سواد سیاسی؟ ۴۵ ساله به یه آخوند میگی رهبر 😂"
- "پروژه موفق شما چی بود؟ جمهوری اسلامی؟ دلار ۱۰۰ هزار تومن؟ 👏"
- "معلوم‌الحال کسیه که ۴۵ ساله یه بار رهبرشو نقد نکرده"

مثال ۳:
توییت: "شاهزاده فراری"
تحلیل: داره میگه رضا پهلوی فرار کرده
نقطه ضعف: خمینی ۱۵ سال تبعید بود
روست: "خمینی ۱۵ سال عراق و پاریس بود، اونم فراری بود؟ 🤡"

⛔ این کارا رو نکن:
- طولانی نویسی (بیشتر از ۱ خط ممنوع!)
- موعظه کردن ("ما رفراندوم میگیم"، "ما دموکراسی میخوایم")
- مناظره و استدلال
- توضیح دادن موضع خودمون
- "جالب است که..."، "با احترام..."
- دو تا سوال پشت سر هم

❌ مثال بد:
"پروژه سیاسی شما که ۴۵ ساله معلوم‌الحال شده، هنوز دارید میچرخونیدش؟ حداقل ما رفراندوم میگیم، شما جز تقلب چی بلدید؟"
چرا بد؟ طولانیه، موعظه میکنه، مناظره‌ست

✅ مثال خوب:
"سواد سیاسی؟ ۴۵ ساله به آخوند میگی رهبر 😂"
چرا خوب؟ یه خطه، میزنه تو هدف، میخندونه
